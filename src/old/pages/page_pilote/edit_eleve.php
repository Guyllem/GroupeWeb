...
<main>
    <div class="form-container">
        ...
        <form id="add-eleve-form" novalidate>
            <div class="form-row">
                <div class="form-column">
                    <div class="form-group">
                        ...
                        <input type="text" id="nom" name="nom" class="form-input" required placeholder="Nom actuel">
                ...
                <div class="form-column">
                    <div class="form-group">
                        ...
                        <input type="text" id="prenom" name="prenom" class="form-input" required placeholder="Prénom actuel">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" class="form-input" required placeholder="Adresse email">
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-submit" id="submit-btn" disabled>Modifier</button>
            </div>
        </form>
    </div>
    ...
    <div class="confirmation-popup" id="confirmationPopup">
        <div class="popup-content">
            <p>L'élève a bien été modifié</p>
