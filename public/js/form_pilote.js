document.addEventListener("DOMContentLoaded", function() {
    ...
    const inputs = [nomInput, prenomInput, emailInput, passwordInput,
        promotionInput, campusInput, telephoneInput];
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            // Ne pas bloquer la soumission en production
            // e.preventDefault();
            ...
            if (submitBtn.disabled) {
                e.preventDefault(); // Bloquer la soumission seulement si le formulaire est invalide
            }
        });
    }
});